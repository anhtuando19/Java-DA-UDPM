...
import Sevice.SanPhamSeviceImp;
...
public class FrameSanPham extends javax.swing.JFrame {
    ...
    private SanPhamSeviceImp sanPhamSevice = new SanPhamSeviceImp();
    ...
    void loadData() {
        ...
        for (SanPham sanPham : sanPhamSevice.getList()) {
            defaultTableModel.addRow(new Object[]{
                stt += 1,sanPham.getMa(), sanPham.getTen()
            });
        }
    }
    boolean check(){
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txt_ma, javax.swing.GroupLayout.PREFERRED_SIZE, 140, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void tbl_sanphamMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbl_sanphamMouseClicked
        ...
        txt_ma.setText(tbl_sanpham.getValueAt(row, 1).toString());
        txt_ten.setText(tbl_sanpham.getValueAt(row, 2).toString());
    ...
    private void btn_xoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_xoaActionPerformed
        ...
        int row = tbl_sanpham.getSelectedRow();
        if(row == -1){
            JOptionPane.showMessageDialog(this, "Chọn dòng xóa");
            return;
        }
        String ma = txt_ma.getText();
        sanPhamSevice.delete(ma);
